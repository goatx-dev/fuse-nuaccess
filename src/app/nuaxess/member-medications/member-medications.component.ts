...
export class MemberMedicationsComponent implements OnInit, OnDestroy {
  ...
  edit(id: any,medication: any,start_date: any,frequency: any, dose: any,reason: any,family_member: any) {
      this.addF='Y'
      this.data['formData'].id=id;
      this.data['formData'].medication=medication;
      this.data['formData'].start_date=start_date;
      this.data['formData'].frequency=frequency;
      this.data['formData'].dose=dose;
      this.data['formData'].reason=reason;
      this.data['formData'].family_member=family_member;
  }
    ...
    postForm() {
        this._dataService.postForm("post-add-medication", this.data).subscribe((data:any)=>{
