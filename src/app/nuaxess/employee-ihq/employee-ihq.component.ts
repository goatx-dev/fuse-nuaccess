...
@Component({
  selector: 'app-employee-ihq',
  templateUrl: './employee-ihq.component.html',
  styleUrls: ['./employee-ihq.component.scss']
})
export class EmployeeIHQComponent implements OnInit, OnDestroy {
