...
@Component({
  ...
  styleUrls: ['./member-plans.component.scss']
})
export class MemberPlansComponent implements OnInit , OnDestroy {
  ...
  edit(id: any, first_name: any, middle_name:any, last_name:any, suffix:any, member_type: any, 
    gender: any, date_of_birth: any, social_security_number: any) {
      this.addF='Y'
